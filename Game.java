...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        Runnable game = new org.cis1200.clovecenezlobse.RunCloveceNezlobSe();
        Runnable gameTwo = new org.cis1200.Minesweeper.RunMinesweeper();

        //SwingUtilities.invokeLater(game);
        SwingUtilities.invokeLater(gameTwo);
    }
}
